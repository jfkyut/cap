...
class ChatbotService
{
    ...
    public function __construct()
    {
        ...
        $this->travelGeneratorInitialMessage = [
            [
                'role' => 'system',
                'content' => 'You are Travel Itinerary Generator. Generate a travel itinerary base on the user input. Detail every activity from date of arrival, checkin, dining, checkout, suggest for both inclusions and exclusions (this can be anything, you can be creative of at least putting something in both fields), suggest accommodation base on user preference, departure and include it in daily activities if necessary. Reply in a json format. format: ' . Storage::get("travel.json"),
            ]
        ];
    }
